  ...
  if (isset($_POST['upload'])) {
	  ...
	  $eprice="";
		...
		//	echo "Sorry, your file was not uploaded.";
			...
			$sql = "INSERT INTO product (name ,quantity, price, type, picture,notwork, working) VALUES ('$name', ' $quantity', '$price','$type','$image','$notwork', '$working')";
  	// execute query
			mysqli_query($db, $sql);
